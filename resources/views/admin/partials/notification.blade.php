<div class="bg-white shadow fixed border top-[4.2rem] right-0 rounded translate-x-full" id="notification">
    <div class="px-4 py-3 flex gap-3">
        ...
        <p class="text-gray-600 font-medium mb-0">Welcome {{ Auth::user()->nama }}</p>
    </div>
