<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white flex flex-col justify-between shadow">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="/post"
                    class="flex items-center p-2 rounded {{ Request::is('post', 'post/*') ? 'sidebar-active' : 'sidebar-base' }} group">
                    <svg class="w-5 h-5 {{ Request::is('post','post/*') ? 'sidebar-active' : 'sidebar-svg' }} transition duration-75"
                        aria-hidden="true" xmlns="http://www./w3.org/2000/svg" fill="none" viewBox="0 0 22 21">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="/arsip"
                    class="flex items-center p-2 rounded {{ Request::is('arsip','arsip/*') ? 'sidebar-active' : 'sidebar-base' }} group">
                    <svg class="w-5 h-5 {{ Request::is('arsip','arsip/*') ? 'sidebar-active' : 'sidebar-svg' }} transition duration-75"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 22 21">
        ...
        <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200">
            <li>
                <form action="{{ url('logout') }}" method="post">
                    @csrf
                    <button type="submit"
                        class="flex justify-center items-center p-2 rounded bg-red-600 text-white group gap-1 w-full">
