<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800 flex flex-col justify-between">
        <ul class="space-y-2 font-medium">
            <li>
                <a href="/dashboard" class="flex items-center p-2 text-blue-600 rounded-lg font-extrabold">
                    <svg class="w-5 h-5 text-blue-600 transition duration-75" aria-hidden="true"
            ...
            <li>
                <a href="/posts"
                    class="flex items-center p-2 text-gray-700 rounded-lg hover:text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
