    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <a href="" class="flex items-center">
                ...
                <span
                    class="self-center text-lg font-semibold whitespace-nowrap leading-none">SIPMA</span>
            </a>
            <br>
            <ul class="space-y-2 font-medium">
                <li >
                    <a href="/dashboard" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-blue-900 group active:bg-gray-600 hover:text-white">
                ...
                <li>
                    <a href="/pengumuman" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-blue-900 group active:bg-gray-600 hover:text-white">
                ...
                <li>
                    <a href="/arsip" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-blue-900 group active:bg-gray-600 hover:text-white">
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Arsip</span>
                    </a>
                </li>
            </ul>
        </div>
